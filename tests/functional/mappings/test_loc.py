...
def test_map_loc_record():
    ...
    assert loc_record.has_part == ['1|https://tile.loc.gov/storage-services/master/gdc/gdcebookspublic/20/24/35/02/89/2024350289/2024350289.pdf|loc|application/pdf|{"download": true}']
